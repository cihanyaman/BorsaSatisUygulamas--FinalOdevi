...
namespace BorsaProjesi
{
    ...
    public class Kullanici
    {
        ...
        private List<UrunBilgi> mahsuller;
        private double bakiye;
        private double bakiyeOnay;

        public void MahsulEkle(UrunBilgi urunBilgi)
        {
            if (mahsuller.Contains(urunBilgi) == false)
            {
                mahsuller.Add(urunBilgi);
            }
        }
        ...
        internal List<UrunBilgi> Mahsuller { get => mahsuller; set => mahsuller = value; }
